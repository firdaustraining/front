<template>
  ...
  <div class="container-fluid mb-5 mt-4">
    ...
    <div class="row">
      <div class="col-md-12">
        <h4 class="font-weight-bold"><i class="fa fa-shopping-bag"></i> PRODUK KAMI</h4>
        ...
        <div class="card h-100 border-0 shadow rounded-md">
          ...
          <div class="card-body">
            ...
            <div class="discount mt-2" style="color: #999" v-if="product.discount > 0">
              <s>Rp. {{ moneyFormat(product.price) }}</s> <span style="background-color: darkorange" class="badge badge-pill badge-success text-white">DISKON {{ product.discount }} %</span>
            </div>
  ...
  <div>
    <!-- <button  id="myBtn" title="Go to top"><i class="fab fa-whatsapp my-float-wa" data-toggle="tooltip" data-placement="left" title="Butuh Bantuan ?" target="_blank"></i> </button> -->
  </div>
</template>
